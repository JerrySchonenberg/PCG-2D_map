...
CHANCE_PLANT = 5  #chance to generate plant (out of 100)
CHANCE_CACTI = 30 #cacti less frequent in desert, lower chance
#=============================================================================

# VILLAGES ===================================================================
CHANCE_HOUSE = 8   #chance of house at pixel (out of 100)
CHANCE_VILLAGE = 2 #chance of generating village (out of 2000)
CHANCE_ROAD = 50   #chance of road between two villages (out of 100)
